      ...
      <div className="w-full max-w-full mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {role === "OPERATOR" ? (
            ...
            /* Technician Action Card */
            <button
              onClick={() => router.push("/admin/tech-jobs")}
              className="group relative flex flex-col items-start p-4 rounded-xl border-2 transition-all hover:border-emerald-400 text-left bg-white cursor-pointer"
              style={{ borderColor: themeColors.border }}
            >
              <div className="p-2.5 rounded-lg bg-emerald-50 text-emerald-500 mb-3 transition-colors group-hover:bg-emerald-500 group-hover:text-white">
              ...
              <p className="text-xs text-gray-500 mb-4">
                Check and update your assigned repair tasks.
              </p>
              <div className="mt-auto flex items-center gap-1.5 font-bold text-[11px] uppercase tracking-wider text-emerald-600">
                View Queue
                <ChevronRight size={14} className="transition-transform group-hover:translate-x-1" />
              </div>
            </button>
